...
// Remember that HTTP requests are asynchronous! We need to wait for the data to load before we can use it
// Also remember that in JavaScript, functions are values - we can pass them as parameters to other functions
